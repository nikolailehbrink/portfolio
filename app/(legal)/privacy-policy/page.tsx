export default function page() {
  return (
    <>
      ...
      <h2>Wer wir sind</h2>
      <p>Die Adresse unserer Website ist: https://nikolailehbr.ink.</p>
      <h2>Kommentare</h2>
      <p>
      ...
      <p>
        Aus deiner E-Mail-Adresse kann eine anonymisierte Zeichenfolge erstellt
        (auch Hash genannt) und dem Gravatar-Dienst übergeben werden, um zu
        prüfen, ob du diesen benutzt. Die Datenschutzerklärung des
      ...
      <p>
        ...
        und wird verworfen, wenn du deinen Browser schließt.
      </p>
      <p>
        ...
        Jahr. Falls du bei der Anmeldung „Angemeldet bleiben“ auswählst, wird
        deine Anmeldung zwei Wochen lang aufrechterhalten. Mit der Abmeldung aus
      ...
      <p>
        ...
        Folgekommentare automatisch erkennen und freigeben, anstatt sie in einer
      ...
      <p>
        Wenn du ein Konto auf dieser Website besitzt oder Kommentare geschrieben
        hast, kannst du einen Export deiner personenbezogenen Daten bei uns
        anfordern, inklusive aller Daten, die du uns mitgeteilt hast. Darüber
        hinaus kannst du die Löschung aller personenbezogenen Daten, die wir von
        dir gespeichert haben, anfordern. Dies umfasst nicht die Daten, die wir
