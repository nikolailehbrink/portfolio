...
// https://github.com/remix-run/react-router/discussions/12672
...
export function mergeRouteModuleMeta<TMetaArgs extends { matches: any[] }>(
  leafMetaFn: (args: TMetaArgs) => MetaDescriptor[],
): (args: TMetaArgs) => MetaDescriptor[] {
  return (args) => {
...
// https://github.com/remix-run/react-router/discussions/12672#discussioncomment-11786919
