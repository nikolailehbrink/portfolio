...
For example, if you look down at your keyboard, you’ll notice that the keys aren’t just flat surfaces. They have a slight inner shadow and gradient that gives them depth.
...
<Alert type="info" className="mt-4">
  ...
  needing to update the gradient on hover.
</Alert>
