...
<Alert type="tip" heading="Related: robots.txt in React Router 7">
  Want to learn how to create and serve a custom <strong>robots.txt</strong>{" "}
  file in React Router 7? Check out my guide: [How to create a robots.txt in
  React Router 7 or Remix](/blog/robots-txt-react-router-7) .
</Alert>
