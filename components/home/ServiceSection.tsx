    ...
    <div className="container grid items-start gap-6 lg:grid-cols-2 lg:gap-12">
      ...
      <div className="service-content flex flex-col items-start gap-3 max-xl:relative lg:sticky lg:top-28">
        ...
        <p>
          ...
          Ich bin davon überzeugt, dich in jeden Schritt einzubeziehen, um deine
          Vision präzise zu erfassen und in eine digitale Realität zu
          übersetzen. Ob es darum geht, eine beeindruckende Webseite zu
          erstellen, überzeugende Marken- und Printdesigns zu produzieren, deine
          lokale Suchpräsenz zu optimieren oder deiner Seite oder Anwendung ein
          frisches Aussehen zu verleihen - ich bin hier, um dir dabei zu helfen,
          ein digitales Erlebnis zu schaffen, das deine Marke wirklich
          widerspiegelt.
        </p>
      </div>
    </div>
