  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        transition-colors outline-none select-none focus-visible:border-ring
        ...
        *:data-[slot=select-value]:gap-1.5 dark:bg-input/30
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        py-1 pr-8 pl-1.5 text-sm outline-hidden select-none focus:bg-accent
