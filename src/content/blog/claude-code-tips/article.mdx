...
<Alert type="tip">
  ...
  [LLM Stack](https://github.com/nikolailehbrink/llm-stack) full-stack starter
  template, which is optimized for agentic development. It gives you a polished
  set of components, a design system and next-gen tooling, handling
  Authentication, Database, and more.
</Alert>
