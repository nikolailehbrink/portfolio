...
By as default, MDX files don't benefit from TypeScript's type checking. That means you can pass incorrect props to components inside `.mdx` files and nothing will warn you.
