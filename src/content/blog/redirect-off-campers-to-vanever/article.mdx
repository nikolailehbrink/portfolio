...
At the beginning of the year, Vanever acquired Off-Campers, including a small part of the team, the website, and the proprietary software developed over the years.
...
Using the redirect list, we applied a simple formula to format the redirects, allowing us to copy them directly from the spreadsheet into our [Caddyfile](https://caddyserver.com/docs/caddyfile). This is the configuration file for the [Caddy web server](https://caddyserver.com/).
...
We could have checked this in the CMS, but given the variety of page types and collections, a script was more efficient.
...
All that remained was to inform Google about the redirect. This was easily done using the [“Change of Address”](https://support.google.com/webmasters/answer/9370220?hl=en) tool.

![Google Search shows redirect](./search-console-redirect.png)

## Conclusion

After two weeks of monitoring the redirect, we observed a significant increase in organic traffic to Vanever and a corresponding drop in traffic to Off-Campers, indicating that the redirect was successful.
